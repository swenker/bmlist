...
CREATE DATABASE  IF NOT EXISTS `bmlist` DEFAULT CHARACTER SET utf8;

CREATE USER 'bmlist'@'%' IDENTIFIED BY 'bmlist1';
GRANT ALL ON bmlist.* TO 'bmlist'@'%';

CREATE USER 'bmlist'@'localhost' IDENTIFIED BY 'bmlist1';
GRANT ALL ON bmlist.* TO 'bmlist'@'localhost';
